...
public enum MovingState {
	...
	Down,
	/**
	 * {@link MovingState#SlowUp} is used when elevator is going up slowly.</br>
	 */
	SlowUp,
	/**
	...
	public boolean isGoingDown() {
		return this == MovingState.SlowDown || this == MovingState.Down;
	}
	...
	public boolean isGoingUp() {
		return this == MovingState.SlowUp || this == MovingState.Up;
	}
